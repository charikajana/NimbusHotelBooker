...
Feature: Galileo vs BCOM Multi Night Multi Room Multi Guest Booking
  ...
  Scenario Outline: Galileo vs BCOM Multi Night Multi Room Multi Guest Virtual Card Booking
    # SHOP Phase
    ...
    Examples:
      ...
      | Spain   | Madrid - Location   | Holiday   | 15 Miles | 60   | 4      | 2     | 5      | Booking.com | No         | false   | Room Only          | Virtual Card   | Cancel by Room   | Agent,Client        |