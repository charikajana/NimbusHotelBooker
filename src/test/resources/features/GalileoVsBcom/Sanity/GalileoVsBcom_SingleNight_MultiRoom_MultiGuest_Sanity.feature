...
Feature: Galileo vs BCOM Single Night Multi Room Multi Guest Booking
  ...
  Scenario Outline: Galileo vs BCOM Single Night Multi Room Multi Guest Virtual Card Booking
    # SHOP Phase
    ...
    Examples:
      ...
      | UK      | London - Location   | Holiday   | 10 Miles | 45   | 1      | 3     | 6      | Booking.com | Yes        | true    | Bed & Breakfast    | Virtual Card   | Full Cancellation| Booker,Travellers   |
