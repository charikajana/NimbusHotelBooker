...
Feature: Galileo vs BCOM Multi Night Single Room Single Guest Booking
  ...
  Scenario Outline: Galileo vs BCOM Multi Night Single Room Single Guest Virtual Card Booking
    # SHOP Phase
