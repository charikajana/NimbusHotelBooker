...
Feature: Galileo vs BCOM Single Night Multi Room Single Guest Booking
  ...
  Scenario Outline: Galileo vs BCOM Single Night Multi Room Single Guest Standard Booking
    # SHOP Phase
