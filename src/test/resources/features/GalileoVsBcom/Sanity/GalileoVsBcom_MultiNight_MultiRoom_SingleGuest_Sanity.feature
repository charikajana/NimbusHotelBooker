...
Feature: Galileo vs BCOM Multi Night Multi Room Single Guest Booking
  ...
  Scenario Outline: Galileo vs BCOM Multi Night Multi Room Single Guest Virtual Card Booking
    # SHOP Phase
    ...
    Examples:
      ...
      | UK      | London - Location   | Holiday   | 10 Miles | 45   | 5      | 3     | 1      | Booking.com | Yes        | true    | Bed & Breakfast    | Virtual Card   | Full Cancellation| Booker,Travellers   |
      | Spain   | Madrid - Location   | Holiday   | 15 Miles | 60   | 7      | 2     | 1      | Booking.com | No         | false   | Room Only          | Virtual Card   | Cancel by Room   | Agent,Client        |