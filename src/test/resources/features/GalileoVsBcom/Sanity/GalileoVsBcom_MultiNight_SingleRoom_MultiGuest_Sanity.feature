...
Feature: Galileo vs BCOM Multi Night Single Room Multi Guest Booking
  ...
  Scenario Outline: Galileo vs BCOM Multi Night Single Room Multi Guest Virtual Card Booking
    # SHOP Phase
    ...
    Examples:
      ...
      | UK      | London - Location   | Holiday   | 10 Miles | 45   | 5      | 1     | 3      | Booking.com | Yes        | true    | Bed & Breakfast    | Virtual Card   | Full Cancellation| Booker,Travellers   |
      | Germany | Berlin - Location   | Holiday   | 15 Miles | 60   | 4      | 1     | 4      | Booking.com | No         | false   | Room Only          | Virtual Card   | Cancel by Room   | Agent,Client        |