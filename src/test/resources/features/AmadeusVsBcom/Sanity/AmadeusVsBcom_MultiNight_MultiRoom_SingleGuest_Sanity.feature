...
Feature: Amadeus vs BCOM Multi Night Multi Room Single Guest Booking
  ...
  Scenario Outline: Amadeus vs BCOM Multi Night Multi Room Single Guest Virtual Card Booking
    # SHOP Phase
    ...
    And user fills guest information for "<rooms>" rooms
    ...
    Then retrieved booking details should match the original reservation with "<rooms>" rooms
    ...
    Examples:
      ...
      | USA     | New York - Location | Holiday   | 20 Miles | 30   | 3      | 2     | 1      | Booking.com | No         | false   | Room Only          | Virtual Card   | Cancel by Room   | Booker,Agent,Client |
      | France  | Paris - Location    | Holiday   | 10 Miles | 45   | 5      | 3     | 1      | Booking.com | Yes        | true    | Bed & Breakfast    | Virtual Card   | Full Cancellation| Booker,Travellers   |
      | Germany | Berlin - Location   | Holiday   | 15 Miles | 60   | 7      | 2     | 1      | Booking.com | No         | false   | Room Only          | Virtual Card   | Cancel by Room   | Agent,Client        |