...
Feature: Amadeus vs BCOM Multi Night Single Room Multi Guest Booking
  ...
  Scenario Outline: Amadeus vs BCOM Multi Night Single Room Multi Guest Virtual Card Booking
    # SHOP Phase
    ...
    Examples:
      ...
      | USA     | New York - Location | Holiday   | 20 Miles | 30   | 3      | 1     | 2      | Booking.com | No         | false   | Room Only          | Virtual Card   | Cancel by Room   | Booker,Agent,Client |
      | France  | Paris - Location    | Holiday   | 10 Miles | 45   | 5      | 1     | 3      | Booking.com | Yes        | true    | Bed & Breakfast    | Virtual Card   | Full Cancellation| Booker,Travellers   |
      | Italy   | Rome - Location     | Holiday   | 15 Miles | 60   | 4      | 1     | 4      | Booking.com | No         | false   | Room Only          | Virtual Card   | Cancel by Room   | Agent,Client        |