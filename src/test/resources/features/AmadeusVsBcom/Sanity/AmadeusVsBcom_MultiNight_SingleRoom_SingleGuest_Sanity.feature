...
Feature: Amadeus vs BCOM Multi Night Single Room Single Guest Booking
  ...
  Scenario Outline: Amadeus vs BCOM Multi Night Single Room Single Guest Virtual Card Booking
    # SHOP Phase
    ...
    Examples:
      ...
      | France  | Paris - Location    | Holiday   | 10 Miles | 45   | 5      | 1     | 1      | Booking.com | Yes        | true    | Bed & Breakfast    | Virtual Card   | Full Cancellation| Booker,Travellers   |
      | Italy   | Rome - Location     | Holiday   | 15 Miles | 60   | 7      | 1     | 1      | Booking.com | No         | false   | Room Only          | Virtual Card   | Cancel by Room   | Agent,Client        |