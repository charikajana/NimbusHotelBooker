...
Feature: Amadeus vs BCOM Single Night Multi Room Single Guest Booking
  ...
  Scenario Outline: Amadeus vs BCOM Single Night Multi Room Single Guest Standard Booking
    # SHOP Phase
    ...
    Examples:
      ...
      | USA     | New York - Location | Holiday   | 20 Miles | 30   | 1      | 2     | 1      | Booking.com | No         | false   | Room Only          | Credit Card    | Cancel by Room   | Booker,Agent,Client |
      | France  | Paris - Location    | Holiday   | 10 Miles | 45   | 1      | 3     | 1      | Booking.com | Yes        | true    | Bed & Breakfast    | Credit Card    | Full Cancellation| Booker,Travellers   |
      | Italy   | Rome - Location     | Holiday   | 15 Miles | 60   | 1      | 2     | 1      | Booking.com | No         | false   | Room Only          | Credit Card    | Cancel by Room   | Agent,Client        |