...
Feature: Amadeus vs BCOM Single Night Single Room Single Guest Booking
  ...
  Scenario Outline: Amadeus vs BCOM Single Night Single Room Single Guest Standard Booking
    # SHOP Phase
    ...
    # BOOK Phase  
    When user selects rate with refundable option "<refundable>" from Active Content Provider "<provider>" availability list
    ...
    Examples:
      ...
      | France  | Paris - Location    | Holiday   | 10 Miles | 45   | 1      | 1     | 1      | Booking.com | Yes        | true    | Bed & Breakfast    | Credit Card    | Full Cancellation| Booker,Travellers   |
      | Italy   | Rome - Location     | Holiday   | 15 Miles | 60   | 1      | 1     | 1      | Booking.com | No         | false   | Room Only          | Credit Card    | Cancel by Room   | Agent,Client        |