...
Feature: Amadeus vs BCOM Single Night Multi Room Multi Guest Booking
  ...
  Scenario Outline: Amadeus vs BCOM Single Night Multi Room Multi Guest Virtual Card Booking
    # SHOP Phase
    ...
    Examples:
      ...
      | USA     | New York - Location | Holiday   | 20 Miles | 30   | 1      | 2     | 4      | Booking.com | No         | false   | Room Only          | Virtual Card   | Cancel by Room   | Booker,Agent,Client |
      | France  | Paris - Location    | Holiday   | 10 Miles | 45   | 1      | 3     | 6      | Booking.com | Yes        | true    | Bed & Breakfast    | Virtual Card   | Full Cancellation| Booker,Travellers   |
      | Netherlands | Amsterdam - Location | Holiday   | 15 Miles | 60   | 1      | 2     | 5      | Booking.com | No         | false   | Room Only          | Virtual Card   | Cancel by Room   | Agent,Client        |