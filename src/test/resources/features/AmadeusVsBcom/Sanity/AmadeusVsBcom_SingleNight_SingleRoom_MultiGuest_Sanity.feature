...
Feature: Amadeus vs BCOM Single Night Single Room Multi Guest Booking
  ...
  Scenario Outline: Amadeus vs BCOM Single Night Single Room Multi Guest Standard Booking
    # SHOP Phase
    ...
    Examples:
      ...
      | France  | Paris - Location    | Holiday   | 10 Miles | 45   | 1      | 1     | 3      | Booking.com | Yes        | true    | Bed & Breakfast    | Credit Card    | Full Cancellation| Booker,Travellers   |
