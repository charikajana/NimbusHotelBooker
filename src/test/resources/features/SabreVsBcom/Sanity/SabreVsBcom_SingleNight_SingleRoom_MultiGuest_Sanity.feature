...
Feature: Sabre vs BCOM Single Night Single Room Multi Guest Booking
  ...
  Scenario Outline: Sabre vs BCOM Single Night Single Room Multi Guest Standard Booking
    # SHOP Phase
    ...
    Examples:
      ...
      | Canada  | Toronto - Location  | Holiday   | 15 Miles | 60   | 1      | 1     | 4      | Booking.com | No         | false   | Room Only          | Credit Card    | Cancel by Room   | Agent,Client        |