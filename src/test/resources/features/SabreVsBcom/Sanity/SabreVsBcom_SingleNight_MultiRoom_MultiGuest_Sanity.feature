...
Feature: Sabre vs BCOM Single Night Multi Room Multi Guest Booking
  ...
  Scenario Outline: Sabre vs BCOM Single Night Multi Room Multi Guest Virtual Card Booking
    # SHOP Phase
    ...
    Examples:
      ...
      | Canada  | Toronto - Location  | Holiday   | 15 Miles | 60   | 1      | 2     | 5      | Booking.com | No         | false   | Room Only          | Virtual Card   | Cancel by Room   | Agent,Client        |