...
Feature: Sabre vs BCOM Multi Night Multi Room Multi Guest Booking
  ...
  Scenario Outline: Sabre vs BCOM Multi Night Multi Room Multi Guest Virtual Card Booking
    # SHOP Phase
    ...
    And user fills guest information for "<rooms>" rooms accommodating "<guests>" guests
    ...
    Then retrieved booking details should match the original reservation for "<rooms>" rooms and "<guests>" guests
    And virtual card status should be displayed as "ACTIVE"
    And overall booking status should show as "CONFIRMED"
    
    # CANCEL Phase
    When user initiates booking cancellation using "<cancel_method>" option option
    ...
    Examples:
      ...
      | USA     | New York - Location | Holiday   | 20 Miles | 30   | 3      | 2     | 4      | Booking.com | No         | false   | Room Only          | Virtual Card   | Cancel by Room   | Booker,Agent,Client |
      | UK      | London - Location   | Holiday   | 10 Miles | 45   | 5      | 3     | 6      | Booking.com | Yes        | true    | Bed & Breakfast    | Virtual Card   | Full Cancellation| Booker,Travellers   |
      | Canada  | Toronto - Location  | Holiday   | 15 Miles | 60   | 4      | 2     | 5      | Booking.com | No         | false   | Room Only          | Virtual Card   | Cancel by Room   | Agent,Client        |