...
Feature: Sabre vs BCOM Multi Night Single Room Multi Guest Booking
  ...
  Scenario Outline: Sabre vs BCOM Multi Night Single Room Multi Guest Virtual Card Booking
    # SHOP Phase
    ...
    Examples:
      ...
      | France  | Paris - Location    | Holiday   | 15 Miles | 60   | 4      | 1     | 4      | Booking.com | No         | false   | Room Only          | Virtual Card   | Cancel by Room   | Agent,Client        |