...
Feature: Sabre vs BCOM Multi Night Multi Room Single Guest Booking
  ...
  Scenario Outline: Sabre vs BCOM Multi Night Multi Room Single Guest Virtual Card Booking
    # SHOP Phase
